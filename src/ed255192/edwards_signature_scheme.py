from ed255192.affine_edwards_curve import AffineEdwardsCurve
from ed255192.edwards_curve import EdwardsCurve
from ed255192.extended_edwards_curve import ExtendedEdwardsCurve
from ed255192.signature_scheme import SignatureScheme
import nacl.hash
...
class Ed25519(SignatureScheme):
    ...
    def __init__(self, secret_key: bytes, curve: EdwardsCurve = AffineEdwardsCurve()):
        ...
        # somehow this fails for the invalid Signature TEST TODO 

...
from x25519.montgomery_ladder import MontgomeryLadder, MontgomeryLadderRFC7748
...
class EllipticCurveDiffieHellman(DiffieHellman):
    ...
    def __init__(self, private_key: Optional[bytes] = None,
                 ladder: Optional[MontgomeryLadder] = None):
        """
        ...
        self.ladder = ladder if ladder is not None else MontgomeryLadderRFC7748()
    ...
    def compute_public_key(self) -> bytes:
        ...
        return self.ladder.x25519(self.private_key, base_point)
    ...
    def generate_shared_secret(self, peer_public_key: bytes) -> bytes:
        ...
        """
        return self.ladder.x25519(self.private_key, peer_public_key)

...
from x25519.double_and import recover_point, x25519
from nacl.bindings import crypto_scalarmult
from parameterized import parameterized
from x25519.double_and import scalar_mult
...
class TestX25519ImplementsRFC7748(unittest.TestCase):
    ...
    def _test_rfc7748_vectors(self, name, k_hex, u_hex, expected_hex):
    ...
    def _test_rfc7748_iterative(self):
        ...
        u = (9, 1478161944758954479102059356840998688726)
        k = 9
        ...
        for i in range(1, 10000 + 1):
            ...
            #k_2, u_2 = scalar_mult(k_2, u_2, y_bytes), k_2
            ...
            if i in expected_outputs:
                ...
                actual = encode_u_coordinate(k[0])
                self.assertEqual(
                    expected,
                    actual,
                    f"Iteration {i}: X25519 output does not match the expected result.",
    ...
    def test(self):
        b = 9
        self.assertEqual(recover_point(b), (9, 14781619447589544791020593568409986887264606134616475288964881837755586237401))
